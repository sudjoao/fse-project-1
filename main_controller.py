...
class MainController:
    ...
    def config(self):
        ...
        for sensors in self.speed_sensors:
            self.speed_controllers.append(SpeedController(
                self.trafic_light_controller.is_red, 
                self.trafic_light_controller.client.inform_car_speed, 
                self.trafic_light_controller.client.send_very_fast_cart
                ))
